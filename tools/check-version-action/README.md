...
This action is located in `tools/check-version-action/` to make it easy to share across repositories.
...
```yaml
- uses: Anyhoosolutions/flutter_platform_kit/tools/check-version-action@main
```
