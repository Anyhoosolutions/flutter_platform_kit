    ...
    return Center(
      child: Theme(
        ...
        child: Container(
          ...
          constraints: BoxConstraints(maxWidth: 340, maxHeight: MediaQuery.sizeOf(context).height * 0.9),
                ...
                children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    ...
                                    width: 1,
                                    style: BorderStyle
                                        .solid, // Flutter doesn't support dashed border natively easily without package
                                  ),
                                ),
                              ),
                              // Blue Triangle
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  width: 32,
                                  height: 32,
                                  decoration: BoxDecoration(color: Colors.amber.shade300, shape: BoxShape.circle),
                                ),
                              ),
                            ],
                          ),
                  ...
                  if (onCancel != null)
                    TextButton(
                      ...
                      child: Text(
                        'Cancel',
                        style: TextStyle(color: Colors.blue.shade600, fontWeight: FontWeight.w600, fontSize: 16),
                      ),
                    ),
                ],
              ),
