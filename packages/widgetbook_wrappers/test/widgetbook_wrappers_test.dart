...
void main() {
  ...
  group('WidgetbookWidgetFrameConfig', () {
    test('default initial frame prefers large', () {
      final config = WidgetbookWidgetFrameConfig.allFrames();
      expect(config.resolveInitialWidgetFrame(), WidgetFrameSize.large);
    });
  });
}
