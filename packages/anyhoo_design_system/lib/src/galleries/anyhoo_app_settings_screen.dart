...
/// Composition screen: profile header and settings sections.
class AnyhooAppSettingsScreen extends StatefulWidget {
  const AnyhooAppSettingsScreen({super.key});

  @override
  State<AnyhooAppSettingsScreen> createState() => _AnyhooAppSettingsScreenState();
}

class _AnyhooAppSettingsScreenState extends State<AnyhooAppSettingsScreen> {
  bool _darkMode = true;
  String _language = 'en';
  double _volume = 50;
