...
/// Showcase of data tables, filter chips, badges, and preference lists.
class AnyhooDataGallery extends StatefulWidget {
  const AnyhooDataGallery({super.key});

  @override
  State<AnyhooDataGallery> createState() => _AnyhooDataGalleryState();
}

class _AnyhooDataGalleryState extends State<AnyhooDataGallery> {
  bool _sync = true;
