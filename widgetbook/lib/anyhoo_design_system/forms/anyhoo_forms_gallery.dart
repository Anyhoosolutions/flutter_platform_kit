...
@widgetbook.UseCase(name: 'Gallery', type: AnyhooFormsGallery, path: 'anyhoo_design_system/forms')
Widget buildAnyhooFormsGallery(BuildContext context) {
  return DesignSystemDeviceFrameWrapper.wrapInDeviceFrame(context, const AnyhooFormsGallery());
}
