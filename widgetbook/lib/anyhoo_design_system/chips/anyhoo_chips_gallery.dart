...
Widget buildAnyhooChipsGallery(BuildContext context) {
  return DesignSystemDeviceFrameWrapper.wrapInDeviceFrame(context, const _AnyhooChipsGallery());
}

class _AnyhooChipsGallery extends StatelessWidget {
  const _AnyhooChipsGallery();
