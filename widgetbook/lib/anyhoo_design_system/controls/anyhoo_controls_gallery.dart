...
Widget buildAnyhooControlsGallery(BuildContext context) {
  return DesignSystemDeviceFrameWrapper.wrapInDeviceFrame(context, const _AnyhooControlsGallery());
}

class _AnyhooControlsGallery extends StatefulWidget {
  const _AnyhooControlsGallery();

  @override
  State<_AnyhooControlsGallery> createState() => _AnyhooControlsGalleryState();
}

class _AnyhooControlsGalleryState extends State<_AnyhooControlsGallery> {
  bool _wifi = true;
