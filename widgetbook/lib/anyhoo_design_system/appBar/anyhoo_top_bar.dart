...
Widget buildAnyhooTopBar(BuildContext context) {
  final useSubtitle = context.knobs.boolean(label: 'Use subtitle', initialValue: false);
  return DesignSystemDeviceFrameWrapper.wrapInDeviceFrame(context, AnyhooAppBarGallery(useSubtitle: useSubtitle));
}
